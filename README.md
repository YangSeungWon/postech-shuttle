...
노선 도형은 정류장 사이를 OSRM 으로 이어 만듭니다. OSRM 은 두 점을 최단으로
이을 뿐이라 실제 회차 경로를 모릅니다. 예를 들어 무은재삼거리는 버스가 온 길로
...
지곡·유강은 단방향 노선이라 오전·오후 운행이 각각 다른 경로를 가집니다.
노선을 고르면 진행 방향 화살표가 함께 표시됩니다.
