...
const STRINGS = {
  ko: {
    ...
    whenTitle: '출발·도착 시각', resetTime: '지금으로 되돌리기', now: '지금 출발', departAt: t => `${t} 출발`,
    all: '전체',
    ...
    sheetOpen: '목록 펼치기', sheetClose: '목록 접기',
    northUp: '북쪽으로 맞추기',
    following: '내 위치 따라가는 중 · 눌러서 방향까지',
    headingOn: '방향까지 따라가는 중 · 눌러서 끄기',
    ...
    kinds: { here: '내 위치', pick: '지도', recent: '최근', stop: '정류장', place: '장소', university: '건물',
  ...
  en: {
    ...
    whenTitle: 'Departure or arrival time', resetTime: 'Back to now', now: 'Leave now', departAt: t => `Leave at ${t}`,
    all: 'All',
    ...
    sheetOpen: 'Expand list', sheetClose: 'Collapse list',
    northUp: 'Reset to north',
    following: 'Following your location · tap for heading',
    headingOn: 'Following heading · tap to stop',
    ...
    kinds: { here: 'My location', pick: 'Map', recent: 'Recent', stop: 'Stop', place: 'Place', university: 'Building',
