...
const STRINGS = {
  ko: {
    ...
    installApp: '홈 화면에 추가',
    installNudge: '홈 화면에 추가하면 앱처럼 바로 열려요',
    installNow: '추가',
    ...
    timetableHint: '교통 상황에 따라 1~2분 차이가 날 수 있으니 출발 시각 전에 도착해 주세요.',
    clockLabel: (h, m) => `현재 시각 ${h}시 ${m}분`,
    sheetOpen: '정류장 목록 펼치기', sheetClose: '정류장 목록 접기',
  ...
  en: {
    ...
    installNudge: 'Add to your home screen to open it like an app',
    installNow: 'Add',
    ...
    timetableHint: 'Times may vary by 1–2 minutes with traffic. Please arrive before the listed time.',
    clockLabel: (h, m) => `Current time ${h}:${m}`,
    sheetOpen: 'Expand stop list', sheetClose: 'Collapse stop list',
